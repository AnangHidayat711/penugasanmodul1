...
function changeChart() {
 ...
 if (selectedOption1 === '401a - Penggunaan Perangkat Digital Untuk Aktivitas') {
    updateChart(config401a);
  } else if (selectedOption1 === '401b - Jenis Perangkat Digital yang Digunakan') {
    updateChart(config401b);
  } else if (selectedOption1 === '403a - Penggunaan Aplikasi untuk Berkomunikasi') {
    updateChart(config403a);
  }  else if (selectedOption1 === '403b - Aplikasi Komunikasi yang Digunakan') {
    updateChart(config403b);
  } else if (selectedOption1 === '405a - Unit Usaha Berdasarkan Pemanfaatan TIK pada Kegiatan Promosi') {
    updateChart(config405a);
  } else if (selectedOption1 === '405b - Sarana Promosi yang Digunakan') {
    updateChart(config405b);
  } else if (selectedOption1 === '407a - Unit Usaha Berdasarkan Pemanfaatan TIK pada Kegiatan Penjualan') {
    updateChart(config407a);
  } else if (selectedOption1 === '407b - Sarana Penjualan Usaha yang Digunakan') {
    updateChart(config407b);
  } else if (selectedOption1 === '409a - Unit Usaha Berdasarkan Pemanfaatan TIK pada Kegiatan Promosi') {
    updateChart(config409a);
